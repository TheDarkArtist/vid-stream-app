import Thumbnail, { ThubnailSkeleton } from "@/components/thumbnail";
...
const ResultCard = ({ data }: ResultCardProps) => {
  return (
    <Link href={`/${data.user.username}`}>
      <div className="w-full flex gap-x-4 border-y rounded-md">
        ...
        <div className="space-y-1 my-2">
          ...
          <p className="text-sm to-muted-foreground">{data.name}</p>
